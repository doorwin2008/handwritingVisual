...
string train_images_path = "D:/doorw_source/CNNHandwriting-main/data/train-images.idx3-ubyte";
string train_labels_path = "D:/doorw_source/CNNHandwriting-main/data/train-labels.idx1-ubyte";
string test_images_path = "D:/doorw_source/CNNHandwriting-main/data/t10k-images.idx3-ubyte";
string test_labels_path = "D:/doorw_source/CNNHandwriting-main/data/t10k-labels.idx1-ubyte";
...
int main()
{
	...
	*/
	...
	//设置跌打条件 最大训练次数为100
	ann->setTermCriteria(TermCriteria(TermCriteria::MAX_ITER | TermCriteria::EPS, 50, 0.0001));

	//开始训练
	cv::Ptr<cv::ml::TrainData> train_data = cv::ml::TrainData::create(train_images, cv::ml::ROW_SAMPLE, train_labels
	);
	cout << "开始进行训练..." << endl;
	if (!ann->train(train_data)) {
